...
export function RestaurantDetailsStep({ onComplete }: RestaurantDetailsStepProps) {
    ...
    return (
        <Card className="max-w-xl mx-auto">
            <h2 className="text-xl font-semibold mb-6">Tell us about your restaurant</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Textarea
                    ...
                    placeholder="Briefly describe your cuisine..."
                    rows={3}
                />
